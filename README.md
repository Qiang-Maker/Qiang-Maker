...
<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=mysql,postgres,redis,docker,linux,git,github,nginx,postman,vscode&perline=10" />
  </a>
</p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>系统化梳理 AI Agent 架构、Function Calling、大模型微调部署与工程实战，打造体系化的技术全景树与实践复盘。</p>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        ...
        <img src="https://img.shields.io/badge/Next.js-16-black?style=flat-square&logo=nextdotjs" alt="nextjs"/>
      </p>
    </td>
    <td width="50%" valign="top">
      <h3>🤝 AI 生态与开源贡献</h3>
      <p><b>积极参与 AI Gateway 与 Agent 基础设施社区</b></p>
      <p>持续跟踪与研究 LiteLLM、OpenHands 等顶级 AI 智能体开源生态，积极参与 Issue 调研与工程实践。</p>
      <p>
